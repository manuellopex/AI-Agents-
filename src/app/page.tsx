      ...
      <div className="relative z-10 flex flex-col min-h-screen xl:h-screen">
        ...
        <div className="flex-1 overflow-y-auto xl:overflow-hidden p-3 sm:p-4 flex flex-col xl:flex-row gap-3 xl:gap-4">
          ...
          <div className="flex-1 min-w-0">
            {/*
              Mobile:       1 column (each card h-[540px])
              Small tablet: 2 columns
              Large tablet: 3 columns
              Desktop xl+:  5 columns filling full height
            */}
            <div className="grid gap-3 xl:gap-4 h-auto xl:h-full
              grid-cols-1
              sm:grid-cols-2
              lg:grid-cols-3
              xl:grid-cols-5">
          ...
          {/* Right sidebar — row on tablet, column on desktop */}
          <div className="
            xl:w-80 xl:flex-shrink-0
            grid gap-3
            grid-cols-1
            sm:grid-cols-2
            lg:grid-cols-4
            xl:grid-cols-1 xl:flex xl:flex-col">
        ...
        {/* Command console — always at the bottom */}
